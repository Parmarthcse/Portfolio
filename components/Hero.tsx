...
const Hero = () => {
  return (
    <div className='pb-20 pt-36'>
      ...
      <div className="h-screen w-full dark:bg-black bg-white dark:bg-grid-white/[0.03] bg-grid-black/[0.2] flex items-center justify-center absolute to-0 left-0">
...
<div className='flex justify-center relative my-20 z-10'>
    <div className='max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center *:justify-center'>
        ...
        <a href='#about'>
          ...
          //import arrow location icon from react icons
